...
export const AP1= () => {
  ...
  return (
    ...
    <img
      src="https://d31aoa0ehgvjdi.cloudfront.net//eyJidWNrZXQiOiJ0aGV0YXJ6YW53YXktd2ViIiwia2V5IjoibWVkaWEvc3RhdGVzLzE2NzUzNTUwNDQ0ODI0MjI1OTAyNTU3MzczMDQ2OS5qcGciLCJlZGl0cyI6eyJyZXNpemUiOnsid2lkdGgiOjIyNDAsImhlaWdodCI6MTA0MCwiZml0IjoiY292ZXIifX19"
      alt="Background"
    ...
    <div className="relative flex items-center justify-between px-10 h-full">
      ...
      <div className="text-white max-w-5xl space-y-6 absolute top-16 left-24">
        <h1 className="text-5xl font-extrabold leading-tight">Arunachal Pradesh <br/>Trip Planner<br />Let AI Be Your Expert Guide.</h1>
    ...
    <div className="absolute bottom-24 left-32 flex space-x-24 text-white text-center">
