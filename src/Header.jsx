  ...
  return (
    ...
    <div className="relative flex items-center justify-between px-10  md:px-10 h-full">
      ...
      <div className="text-white md:space-y-6  md:top-16  xs:top-28 xs:left-20 sm:left-28 left-32 md:left-24 text-center md:text-left max-w-5xl space-y-6 absolute top-40">
        <h1 className="text-5xl xs:text-sm mb-5 xs:mb-2 sm:text-2xl md:text-5xl font-extrabold leading-tight">Effortless Travel Planning!<br />Let AI Be Your Expert Guide.</h1>
        ...
        <button onClick={openPopup} className="bg-yellow-400 hover:bg-black text-black hover:text-white transition-all border border-black font-bold py-3 px-6 rounded-md mt-4 xs-py-1">
    ...
    <div className="absolute bottom-36 mx-5 sm:bottom-32 sm:mx-auto md:bottom-28 xs:mx-auto lg:left-32 left-32 flex space-x-24 text-white text-center">
