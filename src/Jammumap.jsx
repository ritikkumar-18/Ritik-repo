...
function AboutJK() {
  ...
  return (
    <div className='mx-28 '>
      <h1 className='text-4xl font-bold mb-10 text-center mt-10'>A little about Jammu & Kashmir</h1>
      <div className='flex justify-between '>
      <p className='text-gray-500 text-md font-medium mb-5 flex-1 mr-5' >Nestled in the Himalayas, Kashmir is a glittering jewel among India’s many states. Kashmir is known 
      ...
      <div className="w-100% lg:w-2/5 ml-5 flex-2">
        <iframe
          title="Google Map"
