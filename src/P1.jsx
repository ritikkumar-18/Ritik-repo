...
export const P1 = () => {
  ...
  return (
    ...
    <img
      src="https://d31aoa0ehgvjdi.cloudfront.net//eyJidWNrZXQiOiJ0aGV0YXJ6YW53YXktd2ViIiwia2V5IjoibWVkaWEvY2l0aWVzLzE2NTY0Mjk0OTEyNzg0MjI4MzI0ODkwMTM2NzE4OC53ZWJwIiwiZWRpdHMiOnsicmVzaXplIjp7IndpZHRoIjo2MDcsImhlaWdodCI6ODEwfX19"
      alt="Background"
      className="absolute inset-0 w-full h-full object-cover xs:w-full xs:h-full"
    />
    ...
    <div className="relative flex items-center justify-between px-10  md:px-10 h-full">
      ...
      <div className="text-white md:space-y-6  md:top-16  xs:top-16 xs:left-4 sm:mt-24 sm:left-28 left-32 md:left-24 text-center md:text-left max-w-5xl space-y-6 absolute top-40">
        <h1 className="text-5xl xs:text-3xl mb-5 xs:mb-2 sm:text-2xl md:text-5xl font-extrabold leading-tight">Pahalgam Trip Planner<br />Let AI Be Your Expert Guide.</h1>
    ...
    <div className="absolute bottom-36 mx-5 xs:left-2 xs:mr-2  sm:bottom-64 xs:bottom-20 sm:mx-auto md:bottom-28 xs:mx-auto sm:mt-20 lg:left-32 left-32 flex space-x-24 text-white text-center">
