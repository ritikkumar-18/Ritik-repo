...
//   return (
//     <div className="mt-20 h-[80vh] mx-20 xs:h-auto xs:w-auto">
//       <h1 className="text-4xl font-bold mb-10">What they say?</h1>
//       <div className="flex flex-col  items-center py-10">
//         {/* Logos */}
//         <div className="relative flex justify-between gap-20  sm:gap-12 mb-20">
  ...
  return (
    <div className="mt-20 h-[80vh] mx-20 xs:hidden">
      ...
      <div className="flex flex-col items-center py-10">
        ...
        <div className="relative flex justify-between gap-20 3xl:gap-36 mb-32">
          {logos.map((logo, index) => (
            <div
              ...
              ref={(el) => (logoRefs.current[index] = el)}
            >
              <img src={logo.src} alt={logo.alt} className="h-11 object-contain" />
            </div>
          ))}
        ...
        <a href="#full-article" className="text-black text-lg hover:underline mt-10">
          Full Article
        </a>
      </div>
    </div>
