...
export const Jammu = () => {
  ...
  return (
    ...
    <div className="relative flex items-center justify-between px-10  md:px-10 h-full">
      ...
      <div className="text-white md:space-y-6  md:top-16  xs:top-16 xs:left-4  sm:left-28 left-32 md:left-24 text-center md:text-left max-w-5xl space-y-6 absolute top-40">
