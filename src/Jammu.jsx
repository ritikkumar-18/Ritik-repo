...
export const Jammu = () => {
  ...
  return (
    ...
    <div className="relative flex items-center justify-between px-10  md:px-10 h-full">
      ...
      <div className="text-white md:space-y-6  md:top-16  xs:top-16 xs:left-4  sm:mt-24 xs:mt-16 sm:left-28 left-32 md:left-24 text-center md:text-left max-w-5xl space-y-6 absolute top-40">
        <h1 className="text-5xl xs:text-3xl mb-5 xs:mb-2 sm:text-2xl md:text-5xl font-extrabold leading-tight">Jammu & Kashmir<br />Let AI Be Your Expert Guide.</h1>
    ...
    <div className="absolute bottom-36 mx-5 xs:left-2 xs:bottom-20 sm:bottom-72 sm:mx-auto md:bottom-28 xs:mx-auto sm:mt-20 lg:left-32 left-32 flex space-x-24 text-white text-center">
