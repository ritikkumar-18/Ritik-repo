...
export const G1= () => {
  ...
  return (
    ...
    <img
      src="https://d31aoa0ehgvjdi.cloudfront.net//eyJidWNrZXQiOiJ0aGV0YXJ6YW53YXktd2ViIiwia2V5IjoibWVkaWEvcGFnZS8xNjc0NjM2NzY0MTM1Njg3MzUxMjI2ODA2NjQwNjIuanBnIiwiZWRpdHMiOnsicmVzaXplIjp7IndpZHRoIjoyMjQwLCJoZWlnaHQiOjEwNDAsImZpdCI6ImNvdmVyIn19fQ=="
      alt="Background"
    ...
    <div className="relative flex items-center justify-between px-10 h-full">
      ...
      <div className="text-white max-w-5xl space-y-6 absolute top-16 left-24">
        <h1 className="text-5xl font-extrabold leading-tight">Goa Trip Planner<br />Let AI Be Your Expert Guide.</h1>
